...
const TeacherLogin = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-[url('../../public/Vector.jpg')] bg-cover bg-center min-w-screen relative">
